...
| Release issue gates | DONE | `src/release-issue-gates.js`, `docs/qa/release-issue-gates-0.15.0.json`, `test/release-issue-gates.test.js` |
...
| --- | --- | --- |
| npm package identity | DONE | `@jstn-sdk/ma@0.15.0` |
...
| `docs/release-spec.md` release policy | DONE | `v0.15.0` aligned |
| `docs/qa/release-readiness-0.15.0.md` | DONE | current QA evidence |
...
Meta-Architect currently covers the `v0.15.0` release bar for:

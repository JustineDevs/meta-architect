...
- Release line prepared automatically for v0.15.3.
...
- Release line prepared automatically for v0.1.10.

## v0.1.9

- Release line prepared automatically for v0.1.9.
...
- Release line prepared automatically for v0.1.6.

## v0.1.5

- Release line prepared automatically for v0.1.5.
...
- Added explicit plugin marketplace metadata, plugin mirror verification, and first-launch skill installation to the published package.

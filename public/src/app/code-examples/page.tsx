...
function DemoPageContent() {
  ...
  const { code, Component, error, isCompiling, setCode, compileCode } = useAnimationState(
      ...
      <div className="flex-1 flex overflow-hidden px-12">
        ...
        <div className="flex-1 flex flex-col min-w-0 pb-8 overflow-hidden">
          <div className="mb-4 flex items-center gap-4 shrink-0">
            ...
            <div>
              <h2 className="text-lg font-semibold text-foreground">{selectedExample.name}</h2>
              <p className="text-sm text-muted-foreground-dim">{selectedExample.description}</p>
            </div>
          </div>

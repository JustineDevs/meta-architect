# v0.15.3 Requirements & Rules

## Production definition

Meta-Architect `v0.15.3` is production only when:
...
- `package.json` version `0.15.3`
- git tag `v0.15.3`
- `RELEASE.md`
- `CHANGELOG.md`
- `docs/qa/release-readiness-0.15.3.md`
- `docs/qa/release-issue-gates-0.15.3.json`
- green `npm run release:check`
- GitHub release asset `meta-architect_0.15.3_all.deb`
- GitHub release asset `meta-architect-0.15.3-1-any.pkg.tar.xz`
- GitHub release asset `meta-architect-0.15.3-1.noarch.rpm`
...
- issue milestone must match `v0.15.3`

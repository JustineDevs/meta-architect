...
Current release line: `v0.15.1` · package: `@jstn-sdk/ma@0.15.1`
...
and [release readiness record](../../docs/qa/release-readiness-0.15.1.md) for
...
For this repository:
- plugin scope is aligned to Meta-Architect `v0.15.1`

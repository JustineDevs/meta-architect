...
- package, skill bundle, and release surfaces aligned to `v0.1.14`
...
- release docs, changelog, package metadata, and workflows all remain aligned to `v0.1.14`
- every `v0.1.14` issue in `docs/qa/release-issue-gates-0.1.14.json` is marked `passed` with implementation, verification, and production evidence

Current release-readiness state:
- `docs/qa/release-issue-gates-0.1.14.json` records all tracked `v0.1.14` issues as `passed` with implementation, verification, production proof, and labels
- local release gates passed before publish and must remain green for any follow-up PR
- npm publication completed for `@jstn-sdk/ma@0.1.14`

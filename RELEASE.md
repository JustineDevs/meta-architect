...
- package, skill bundle, and release surfaces aligned to `v0.14.2`
...
- release docs, changelog, package metadata, and workflows all remain aligned to `v0.14.2`
- every `v0.14.2` issue in `docs/qa/release-issue-gates-0.14.2.json` is marked `passed` with implementation, verification, and production evidence

Current release-readiness state:
- `docs/qa/release-issue-gates-0.14.2.json` records all tracked `v0.14.2` issues as `passed` with implementation, verification, production proof, and labels
- local release gates passed before publish and must remain green for any follow-up PR
- npm publication: pending verification after the `v0.14.2` tag is published
